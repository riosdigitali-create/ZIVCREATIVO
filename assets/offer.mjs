...
export function buildDemoMessage(request) {
  ...
  return [
    ...
    "Entiendo que el proyecto con ZIV es de pago único y que el alcance y calendario se confirman por escrito.",
    "Entiendo que servicios externos pueden generar costos cobrados por sus respectivos proveedores.",
